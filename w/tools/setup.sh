...
# echo "Configuring Wordpress..."
# wp core config --dbhost="mariadb" --dbname="WordPressDatabase" --dbuser="ivork" --dbpass="password" --dbcharset="utf8" --dbcollate="utf8_general_ci" --allow-root

# echo "Setting permissions..."
# chmod 644 wp-config.php

# echo "Installing Wordpress..."
# wp core install --url="ivork.42.fr" --title="myvaction" --admin_name="admin" --admin_password="Amsterdam123456" --admin_email="ivork@gmail.com" --skip-email --allow-root

# echo "Creating Wordpress user idan..."
# wp user create "idan" "ivork@codam.nl" --user_pass="123456" --role=author --allow-root
